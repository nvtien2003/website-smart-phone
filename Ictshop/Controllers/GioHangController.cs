...
namespace Ictshop.Controllers
{
    public class GioHangController : Controller
    {
        ...
        public ActionResult DatHang(FormCollection donhangForm)
        {
            ...
            string email = donhangForm["GuestEmail"].ToString();
            int ptthanhtoan = Int32.Parse(thanhtoan);

            Nguoidung kh = (Nguoidung)Session["use"];
            if (kh == null)
            {
                // Tạo người dùng tạm thời nếu không đăng nhập
                kh = new Nguoidung
                {
                    Matkhau = "", // Có thể để trống hoặc tạo mật khẩu ngẫu nhiên
                    IDQuyen = 3, // Mã quyền người dùng tạm thời
            ...
            Donhang ddh = new Donhang
            {
                ...
                Tongtien = 0 // sẽ tính toán ở phần dưới
            };
